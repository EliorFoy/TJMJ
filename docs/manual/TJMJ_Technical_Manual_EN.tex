...
\begin{minipage}{0.95\linewidth}
\small\textbf{\color{blue!60!black}Keywords:} \textbf{Mahjong $\cdot$ Full-Stack Web $\cdot$ Real-Time Multiplayer $\cdot$ Agora $\cdot$ Node.js $\cdot$ Vue 3 $\cdot$ Recursive Backtracking $\cdot$ Cross-Platform} \\
